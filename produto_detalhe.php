...
<div class="card mb-3">
    <img src="https://i.zst.com.br/thumbs/12/3e/39/-522515954.jpg" class="card-img-top" style="margin-top:20px; width: 18rem;">
    <div class="card-body">
        ...
        <p class="card-text">
        <form method="post">
            <input class="btn btn-success" type="submit" name="adicionar_sacola" value="Adicionar à Sacola">
        </form>
        </p>
